...
urlpatterns = [
    ...
    path('assign_task/', views.assign_task_to_user, name='assign_task_to_user'),
    path('preguntar/', views.enviar_pregunta, name='enviar_pregunta'),
    path('preguntas/', views.ver_preguntas, name='preguntas'),
